...
public class Validaciones {
    ...
    public static boolean esPrecio(JTextField txt)
    {
        try{
    ...
    public static boolean esCodigo(JTextField txt)
    {
        boolean ok=true;
        if (!txt.getText().trim().matches("[0-9]{4}"))
        {
            txt.setBorder(BorderFactory.createLineBorder(Color.red));
            txt.setBackground(Color.pink);
            ok=false;
    ...
    {
        boolean ok=true;
        if(!((txt.getText().trim().length()==10)||(txt.getText().trim().length()==4))){
            txt.setBorder(BorderFactory.createLineBorder(Color.red));
            txt.setBackground(Color.pink);
            ok=false;
        }
    ...
    //colocar más metodos de validacion
}
